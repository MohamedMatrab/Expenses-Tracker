...
export class FullComponent implements OnInit {
  get isCollapsedWidthFixed(): boolean {
    return this._isCollapsedWidthFixed;
  }

  set isCollapsedWidthFixed(value: boolean) {
    this._isCollapsedWidthFixed = value;
  }
  get isContentWidthFixed(): boolean {
    return this._isContentWidthFixed;
  }

  set isContentWidthFixed(value: boolean) {
    this._isContentWidthFixed = value;
  }
